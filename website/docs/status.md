...
description: What Harness 0.9.0 can do today and which claims are not yet earned.
---

# Status and limitations

Harness is pre-v1. Version `0.9.0` was tagged on 2026-08-31; this documentation describes that
release.
